...
@Component({
      ...
      <div class="sa-table-wrap">
        <table class="sa-table">
          ...
          <tbody>
            ...
            @if (subs().length === 0) {
              <tr><td colspan="7" style="text-align:center;color:#94a3b8;padding:40px">Nenhuma assinatura encontrada</td></tr>
            }
          </tbody>
        </table>
      </div>
  ...
  `,
    styles: `
    .status-select { width: 140px; padding: 6px 10px; font-size: 13px; }
    .time-ok { color: #059669; font-weight: 600; }
    .time-warn { color: #d97706; font-weight: 600; }
    .time-danger { color: #dc2626; font-weight: 600; }
